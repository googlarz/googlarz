...
| [signal-mcp](https://github.com/googlarz/signal-mcp) | The most complete Signal MCP server and CLI — 25 tools, local history, FTS5 search, Signal Desktop import. Runs 100% locally via signal-cli. |
