...
| [fashion-skill](https://github.com/googlarz/fashion-skill) | Personal AI stylist for any gender — learns your body and direction, builds a wardrobe inventory, recommends outfits by occasion, runs pre-purchase checks, gets sharper every time you wear something. |
...
| [deterministic-workflow-builder-skill](https://github.com/googlarz/deterministic-workflow-builder-skill) | Compiles vague "make it deterministic" asks into a workflow package — typed `workflow.json` manifest, explicit shell steps, approval gates, contract checks, replayable audits, rollback hooks. AI sidecars stay advisory, never decisive. |
...
| | |
|---|---|
| [proton-mail-bridge-mcp](https://github.com/googlarz/proton-mail-bridge-mcp) | Local-first Proton Mail for Claude Desktop and terminal — read, search, draft, send, sync, manage, all through Proton Bridge. Never through a cloud relay. |
