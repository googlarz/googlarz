...
| | |
|---|---|
| [vibe-safe](https://github.com/googlarz/vibe-safe) | Active session guardian for non-technical contributors (PMs, designers) shipping AI-assisted code in shared codebases. 28 risk categories: credentials outside your diff, quality gate weakening, XSS sinks, SSL bypass, private key files, error suppression, test bypasses, and more. Every flag cites file:line. Pre-commit hook with 21 checks runs without Claude — this is the complete vibecoding failure surface. |
